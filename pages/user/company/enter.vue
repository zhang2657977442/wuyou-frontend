	...
	<view class="content reg-page">
		<view class="input-group">
			...
			<view class="input-column border-bottom-1px">
				...
				<view class="input-item"><input class="padding-10" placeholder="请输入公司简称" v-model="company.name" /></view>
			</view>
			<view class="input-column border-bottom-1px">
				<text class="title">公司全称</text>
				<view class="input-item"><input class="padding-10" placeholder="请输入公司全称" v-model="company.fullName" /></view>
			</view>
